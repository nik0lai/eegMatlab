...
for countChann = 1:numel(cfg_darks.channelpools);     % counter
    ...
    if (isfield(cfg_darks, 'special_anal'))
        mkdir([cfg_darks.plots_folder_path cfg_darks.session cfg_darks.folder_to_plot '/' cfg_darks.special_anal]) 
        
        saveas(gcf, [cfg_darks.plots_folder_path ...
                     cfg_darks.session ...
                     cfg_darks.folder_to_plot '/' ...
    ...
    elseif (~isfield(cfg_darks, 'special_anal'))
        mkdir([cfg_darks.plots_folder_path cfg_darks.session cfg_darks.folder_to_plot]) 
